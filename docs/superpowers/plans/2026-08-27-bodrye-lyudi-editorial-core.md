...
> **УСТАРЕЛО — НЕ ПРОДОЛЖАТЬ.** План основан на прежней спецификации и содержит удалённый scope. Неизменённая копия сохранена в `docs/archive/2026-08-28-pre-mvp-cleanup/legacy-plan-2026-08-27.md`. Рабочая спецификация: `docs/superpowers/specs/2026-08-28-bodrye-lyudi-mvp-design.md`; для неё потребуется новый implementation plan.
